...
function AdopterLanding() {
  ...
  const campaignImages = useMemo(
    () => [
      ...
      "/images/campaign/campaign4.png",
      "/images/campaign/campaign5.png",
      "/images/campaign/campaign6.png",
    ],
    []
  );
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => {
        const next = prev + 1;
        return next >= campaignImages.length ? 0 : next;
      });
    }, 3000);
        ...
        <section className="section more-info">
          ...
          <div className="asean-header">
            ...
            <p>
              ...
              contribute to the growing number of stray cats and dogs in cities
              across the region.
            </p>
          </div>
        </section>
