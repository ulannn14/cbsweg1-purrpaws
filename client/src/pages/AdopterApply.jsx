...
function AdopterApply() {
    ...
    const handleChange = (e) => {
        ...
        setErrors((prev) => {
            ...
            if (name === "interviewTime") {
                if (!value) {
                    updatedErrors.interviewTime = true;
                } else {
                    const selectedDate = new Date(value);
                    const now = new Date();
                    updatedErrors.interviewTime = selectedDate <= now;
                }
            }
    ...
    const validateForm = () => {
        ...
        if (!formData.interviewTime) {
            newErrors.interviewTime = true;
        } else {
            const selectedDate = new Date(formData.interviewTime);
            const now = new Date();
                                                        ...
                                                        <div className="file-preview">
                                                            {formData.validId.map((file, i) => (
                                                                <div key={i} className="file-chip">
                                                                    {file.name}
                                                                    <button type="button" onClick={() => removeFile("validId", i)}>×</button>
                                                                </div>
                                                            ))}
                                                        </div>
                                                        {errors.validId && (
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="file-preview">
                                                                {formData.consentProof.map((file, i) => (
                                                                    <div key={i} className="file-chip">
                                                                        {file.name}
                                                                        <button type="button" onClick={() => removeFile("consentProof", i)}>×</button>
                                                                    </div>
                                                                ))}
                                                            </div>
                                                            {errors.consentProof && (
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <div className="file-preview">
                                                            {formData.housePhotos.map((file, i) => (
                                                                <div key={i} className="file-chip">
                                                                    {file.name}
                                                                    <button type="button" onClick={() => removeFile("housePhotos", i)}>×</button>
                                                                </div>
                                                            ))}
                                                        </div>
                                                        {errors.housePhotos && (
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    {errors.interviewTime && (
                                                        <p className="error-text">
                                                            Please select a date and time later than the current time
                                                        </p>
                                                    )}
                                                </div>
                                            )}
